...
void Vtestbench___024root__trace_chg_sub_0(Vtestbench___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+23,(vlSelf->testbench__DOT__dut__DOT__counter_inst__DOT__addin_l),25);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgBit(oldp+24,(vlSelf->testbench__DOT__reset_i));
        bufp->chgCData(oldp+25,(vlSelf->testbench__DOT__rg__DOT__ctr_lo_r),2);
        bufp->chgCData(oldp+26,(vlSelf->testbench__DOT__rg__DOT__ctr_hi_r),2);
        bufp->chgBit(oldp+27,((2U == (IData)(vlSelf->testbench__DOT__rg__DOT__ctr_lo_r))));
        bufp->chgBit(oldp+28,((2U == (IData)(vlSelf->testbench__DOT__rg__DOT__ctr_hi_r))));
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgIData(oldp+29,(vlSelf->testbench__DOT__dut__DOT__cfstep_l),32);
        bufp->chgBit(oldp+30,((1U & (vlSelf->testbench__DOT__dut__DOT__counter_inst__DOT__dffout_l 
                                     >> 0x18U))));
        bufp->chgCData(oldp+31,(vlSelf->testbench__DOT__dut__DOT__cstate_l),2);
        ...
        bufp->chgIData(oldp+35,(vlSelf->testbench__DOT__dut__DOT__counter_inst__DOT__dffout_l),25);
        bufp->chgBit(oldp+36,(vlSelf->testbench__DOT__dut__DOT__counter_reset));
        bufp->chgBit(oldp+37,(vlSelf->testbench__DOT__dut__DOT__test));
    ...
    bufp->chgCData(oldp+43,(vlSelf->testbench__DOT__dut__DOT__nstate_l),2);
