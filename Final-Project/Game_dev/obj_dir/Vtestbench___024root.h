...
class Vtestbench___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ testbench__DOT__dut__DOT__counter_reset;
    CData/*0:0*/ testbench__DOT__dut__DOT____Vcellinp__counter_inst__reset_i;
    CData/*0:0*/ testbench__DOT__dut__DOT__test;
    ...
    IData/*24:0*/ testbench__DOT__dut__DOT__counter_inst__DOT__dffout_l;
    IData/*24:0*/ testbench__DOT__dut__DOT__counter_inst__DOT__addin_l;
    IData/*25:0*/ testbench__DOT__dut__DOT__counter_inst__DOT____Vcellout__adder_inst__sum_o;
